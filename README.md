...
## 📚 Create Knowledge Books (EPUB)

Transform AI Briefs into structured EPUB books you can read anywhere.

AI Context Pack uses the knowledge structure generated by AI Briefs to create readable books — not just a Markdown export:
...
Useful for personal learning books, travel guides, recipe books, art history guides, and any vault you want to read on a device.
